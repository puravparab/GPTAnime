    ...
    <div className="min-h-screen flex flex-col bg-cover bg-center relative" style={{ backgroundImage: 'url("/assets/images/background.png")' }}>
      <div className="text-center text-white p-8 relative z-10 pt-32">
        ...
        <div className="space-y-4 max-w-xs mx-auto">
          <Link
            href="/"
            className="block w-full py-2 px-8 text-xl font-bold rounded-full text-sky-800 bg-white/50 hover:bg-white/70 border border-white/60 transition-all duration-200 ease-in-out"
          >
            Return home
          </Link>
        </div>
